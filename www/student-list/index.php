...
include "../components/edit-modal/index.php";
    ...
    <main class="container row m-auto">
        ...
        <div>
            ...
            <?php elseif (!empty($_GET['type']) && $_GET['type'] == "edit"): ?>
                ...
                <?php elseif(isset($_GET['success'])): ?>
                    <p class="text-success">修正に成功しました。</p>
                <?php endif; ?>
            <?php endif; ?>
            <table class="table">
                <thead>
                ...
                <tbody>
                    <?php foreach ($students as $student) : ?>
                        <tr>
                            ...
                            <td>
                                <?php
                                    $editModal = new EditModal($student);
                                    $editModal->render();
                                ?>
                            </td>
                            <td>
                                <form action="/api/delete-student/index.php" method="post" class="delete-student-form">
